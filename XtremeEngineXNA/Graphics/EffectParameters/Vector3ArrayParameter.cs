...
{
    /// <summary>
    /// Effect parameter which stores an array of Vector3's.
    /// </summary>
    public class Vector3ArrayParameter : XEffectParameter<Vector3[]>
    {
        /// <summary>
        ...
        public Vector3ArrayParameter(Root root, string name, Vector3[] values) :
        ...
        public Vector3ArrayParameter(Root root, string name, Vector3[] values, Effect effect) :
        ...
        public override void SetOnEffect(SceneNode node)
        {
            ...
            {
                throw new Exception("Vector3ArrayParameter.SetOnEffect(): " + e.Message);
            }
#endif
        }
    }
