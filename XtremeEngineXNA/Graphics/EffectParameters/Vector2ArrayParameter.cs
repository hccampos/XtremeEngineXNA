...
{
    /// <summary>
    /// Effect parameter which stores an array of Vector2's.
    /// </summary>
    public class Vector2ArrayParameter : XEffectParameter<Vector2[]>
    {
        /// <summary>
        ...
        public Vector2ArrayParameter(Root root, string name, Vector2[] values) :
        ...
        public Vector2ArrayParameter(Root root, string name, Vector2[] values, Effect effect) :
        ...
        public override void SetOnEffect(SceneNode node)
        {
            ...
            {
                throw new Exception("Vector2ArrayParameter.SetOnEffect(): " + e.Message);
            }
#endif
        }
    }
