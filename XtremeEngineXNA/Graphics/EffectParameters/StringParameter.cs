...
namespace XtremeEngineXNA.Graphics.EffectParameters
{
    ...
    /// </summary>
    public class StringParameter : XEffectParameter<string>
    {
        /// <summary>
        ...
        public StringParameter(Root root, string name, string value) :
        ...
        public StringParameter(Root root, string name, string value, Effect effect) :
        ...
        public override void SetOnEffect(SceneNode node)
        {
            ...
            {
                throw new Exception("StringParameter.SetOnEffect(): " + e.Message);
            }
#endif
        }
    }
