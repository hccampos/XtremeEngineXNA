...
{
    /// <summary>
    /// Effect parameter which stores a Vector2.
    /// </summary>
    public class Vector2Parameter : XEffectParameter<Vector2>
    {
        /// <summary>
        ...
        public Vector2Parameter(Root root, string name, Vector2 value) :
        ...
        public Vector2Parameter(Root root, string name, Vector2 value, Effect effect) :
        ...
        public override void SetOnEffect(SceneNode node)
        {
            ...
            {
                throw new Exception("Vector2Parameter.SetOnEffect(): " + e.Message);
            }
#endif
        }
    }
