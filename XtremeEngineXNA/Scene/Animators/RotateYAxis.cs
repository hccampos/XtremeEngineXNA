...
{
    /// <summary>
    /// Animator which rotates a node around the Y axis at a certain speed.
    /// </summary>
    public class RotateYAxis : Base, IAnimator
    {
        #region Attributes
        ...
        #region RotateYAxis Members

        /// <summary>
        /// Creates a new animator which rotates a node around the Y axis.
        /// </summary>
        ...
        /// </param>
        public RotateYAxis(Root root, float rotationSpeed): base(root)
        {
        ...
        public void Update(TimeSpan elapsedTime, SceneNode node)
        {
            ...
            node.Rotate(Vector3.UnitY, mRotationSpeed * elapsed);
        }
